...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  const { _id, id, title, image, paragraph, author, tags, publishDate } = blog as any;
  const blogImage = image && image !== "" ? image : "https://images.unsplash.com/photo-1541462608141-ad4d05ed08fd?auto=format&fit=crop&w=1200&q=80";
  const authorImage = author?.image && author.image !== "" ? author.image : "https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y";
  const blogId = _id || id;
